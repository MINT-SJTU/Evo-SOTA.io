...
export default function MethodologyContent({ benchmarks }: { benchmarks: Benchmark[] }) {
  const { t } = useLanguage();
  const texts = t.dex.methodology;
            ...
            {benchmarks.map((benchmark) => {
              ...
              return (
                <a
                  ...
                  style={{
                    backgroundColor: toHsla(accent, 0.12),
                    borderColor: toHsla(accent, 0.4)
                  }}
                >
