...
export default function Home() {
    ...
    const formatNewsContent = (content: string) => {
        ...
        const models = [
            ...
            'VLANeXt', 'PointACT', 'BehaviorVLA', 'GridS', 'LDA-1B', 'WorldPilot', 'GEAR-VLA', 'ActionMap', 'QDepth-VLA', 'VeriSpace', 'MemoryVLA++', 'MotionVLA', 'TBD-VLA', 'RhinoVLA', 'LARA', 'AffordanceVLA', 'WLA-0', 'ERVLA', '3DThinkVLA', 'GeoAlign', 'Qwen-VLA', 'GuidedVLA', 'AttenA+', 'BehaviorVLA', 'HARP-VLA', 'ELAN4D', 'GaussianDream', 'NIAF', 'OneWM-VLA'
        ];
