...
export default function Home() {
    ...
    const formatNewsContent = (content: string) => {
        ...
        const models = [
            ...
            'OpenVLA', 'Pi0', 'RIPT', 'NORA-1.5', 'Being-H0.5', 'EO-1', 'DreamVLA', 'Rlinf-VLA', 'pi-RL', 'UnifoLM-VLA-0', 'Giga-Brain-0.1', 'RDT-1B', 'Abot-M0', 'DM0', 'Xiaomi-Robotics-0', 'VLA-JEPA', 'JEPA-VLA', 'Pose-VLA'
        ];
