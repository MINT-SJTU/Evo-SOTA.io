...
export default function Home() {
    ...
    const formatNewsContent = (content: string) => {
        ...
        const models = [
            ...
            'QuantVLA', 'Fast-ThinkAct', 'ATA', 'SRPO', 'LingBot-VA', 'RynnVLA-002', 'X-VLA', 'SaiVLA-0', 'Atomic VLA', 'FutureVLA', 'MergeVLA', 'GST-VLA', 'ReViP', 'DiT4DiT', 'Cosmos Policy', 'SimVLA', 'CORAL', 'HiF-VLA', 'AVA-VLA', 'VLA-RFT', 'Mantis', 'ROCKET', 'Dual-CoT VLA', 'VP-VLA', 'GR00T'
        ];
