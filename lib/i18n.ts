    ...
    en: {
        ...
        dex: {
            home: {
                ...
                description: 'Track state-of-the-art performance across Adroit, DexArt, Bi-DexHands, and DexGraspNet with standardized metrics and reproducibility notes.',
                viewLeaderboard: 'View Leaderboard',
            ...
            methodology: {
                ...
                dataSourceDesc: 'All benchmark results are collected from published papers and official repositories. We do not re-run experiments.',
                rankingRules: 'Ranking Rules',
                rankingRulesDesc: 'Models are ranked by their primary metric on each benchmark. For Adroit, DexArt, and Bi-DexHands, this is the Mean Success Rate. DexGraspNet uses Suc.1 (stable under at least one random external force, also called GSR).',
                limitations: 'Known Limitations',
                limitationsDesc: 'Results across different benchmarks are not directly comparable. Different papers may use slightly different evaluation protocols.',
                disclaimer: 'Disclaimer',
                disclaimerDesc: 'Cross-benchmark comparisons should be avoided. Each benchmark has its own evaluation protocol and metrics.',
                ...
                dataNoticeDesc1: 'Data notice last updated: May 24, 2026.',
    ...
    zh: {
        ...
        dex: {
            home: {
                ...
                description: '追踪 Adroit、DexArt、Bi-DexHands 和 DexGraspNet 上的最新结果，统一展示指标与可复现性说明。',
                viewLeaderboard: '查看排行榜',
                latestUpdates: '最新更新',
            ...
            methodology: {
                ...
                dataSourceDesc: '所有基准测试结果均来自已发表的论文和官方代码库。我们不重新运行实验。',
                rankingRules: '排名规则',
                rankingRulesDesc: '模型根据每个基准测试的主要指标进行排名。对于 Adroit、DexArt 和 Bi-DexHands，主要指标为平均成功率。DexGraspNet 则使用的是 Suc.1（至少在一种随机外部力作用下保持稳定，也被称为 GSR）。',
                limitations: '已知局限性',
                ...
                dataNotice: '数据说明',
                dataNoticeDesc1: '数据说明最后更新于：2026 年 5 月 24 日。',
